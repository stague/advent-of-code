...
class Dec16 : PuzzleDayTester(16, 2021) {
    ...
    override fun part1(testFileSuffix: Int?): Any = parse().parsePacket().first!!.calcVersion()
    override fun part2(testFileSuffix: Int?): Any = parse().parsePacket().first!!.calcValue()
