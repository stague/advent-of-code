...
class Dec15 : PuzzleDayTester(15, 2015) {
    ...
    override fun part1(testFileSuffix: Int?): Any = expandScoops(100L, mapOf(), parse(), null) ?: -1

    override fun part2(testFileSuffix: Int?): Any = expandScoops(100L, mapOf(), parse(), 500) ?: -1
