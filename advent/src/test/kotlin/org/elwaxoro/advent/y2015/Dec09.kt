...
class Dec09 : PuzzleDayTester(9, 2015) {
    ...
    override fun part1(testFileSuffix: Int?): Any = findBestPath(parse(), connectLoop = false, ::minPath, ::minCost)

    override fun part2(testFileSuffix: Int?): Any = findBestPath(parse(), connectLoop = false, ::maxPath, ::maxCost)
